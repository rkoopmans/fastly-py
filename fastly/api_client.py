...
from fastly import rest
from fastly.configuration import Configuration
from fastly.exceptions import ApiTypeError, ApiValueError, ApiException
from fastly.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'fastly-py/4.2.2'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = AclApi()
        api_instance.create_acl  # this is an instance of the class Endpoint
        api_instance.create_acl()  # this invokes api_instance.create_acl.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.create_acl.callable or self.callable in this class
